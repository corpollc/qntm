...
> Archived Go-era demo. The commands and code paths shown here now live under `attic/go/` and are no longer part of the active Python/TypeScript surface.
...
Build the archived CLI: `cd attic/go && go build -o /tmp/qntm ./attic/cmd/qntm/`
