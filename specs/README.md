...
**Entity Verification v1.0 RATIFIED — UNANIMOUS** (2026-03-24) — 4/4 founding members signed off. Third ratified spec.
...
- [`entity-verification.md`](./working-group/entity-verification.md) — Entity verification via Corpo API — **v1.0 RATIFIED UNANIMOUS**
