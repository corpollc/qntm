...
| Adapters | OpenClaw, retained NanoClaw, and Claude channel tests/typecheck; OpenClaw 2026.9.3 compiled-package install, encrypted replies, rekey/removal, failed host admission and process-crash recovery on Node 24; real MCP channel transport; runtime dependency audits |
