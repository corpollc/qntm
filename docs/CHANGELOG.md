...
- Added matching Python and TypeScript helpers that prepare an authorized contact addition with fresh group keys, recipient-encrypted welcomes and public group locator links. Tests cover earlier-history exclusion, removal/readmission, member-initiated addition, real relay delivery and fresh cross-language exchanges.
