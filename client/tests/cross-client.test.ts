 ...
 * Verifies that TypeScript crypto primitives produce identical output to the Go implementation.
 * Test vectors are generated by: go run ./crosstest/generate_vectors.go
 */
